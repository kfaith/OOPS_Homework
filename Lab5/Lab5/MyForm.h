...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(102, 210);
			...
			// timerSpeedTrackBar
			// 
			this->timerSpeedTrackBar->Location = System::Drawing::Point(89, 159);
...
#pragma endregion
	...
	private: System::Void MyForm_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
		...
		Graphics^ g = e->Graphics; g->FillEllipse(gcnew SolidBrush(Color::Red), ball_x, ball_y, BALLSIZE, BALLSIZE);
	}
...
private: System::Void MyForm_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
	...
	int ballTop = ball_y;
	int ballBottom = ball_y + BALLSIZE;

	int ballRight = ball_x +(BALLSIZE);
	int ballLeft = ball_x;


	if (e->Y <= ballBottom && e->Y >= ballTop && e->X <= ballRight && e->X >= ballLeft)
	{
